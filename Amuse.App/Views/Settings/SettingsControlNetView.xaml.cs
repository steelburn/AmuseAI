...
namespace Amuse.App.Views
{
    ...
    public partial class SettingsControlNetView : ViewBase
    {
        ...
        public SettingsControlNetView(Settings settings, NavigationService navigationService, IModelDownloadService downloadService, IHistoryService historyService, ILogger<SettingsControlNetView> logger)
            : base(settings, navigationService, downloadService, historyService, logger)
        {
            ...
            ModelCollection.SortDescriptions.Add(new SortDescription(nameof(ControlNetModel.Backend), ListSortDirection.Descending));
            ...
            SelectedModel = ModelCollection.CurrentItem as ControlNetModel;
            InitializeComponent();
        }
